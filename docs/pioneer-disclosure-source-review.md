...
Final company-boundary correction (.58): actual review identified Twiss Birmingham, a member of the first handcart company, being included in a Willie/Martin answer because his paragraph was adjacent. All focal Pioneer packs now require a direct topic phrase, with only the explicit 1847 route overview retained as scoped landmark context. Willie/Martin focal phrases use the company names rather than generic snow, arrival, or rescue terms. Cold/warm regression excludes the neighboring first-company recollection.

Bounded independent rewrite (.59): the broader live gate continued to reject a Hyrum follow-up after same-provider paraphrase repair. When a successful Groq primary overcopies evidence and the existing OpenAI verifier is configured, the one permitted repair now uses that existing verifier. It adds no call, model, credential, or deadline allowance; combined usage accounting and final publication gates are preserved. End-to-end regression asserts one Groq call, one OpenAI repair, and verified independently worded output.

Complete history evidence (.60): live retrieval reproduced a Hyrum excerpt ending mid-sentence at “He succeeded his father, Josep”, before his Nauvoo offices. Deterministic Church History evidence now retains whole selected paragraphs within the existing 4200-character evidence allowance instead of slicing at1200. Cold and warm canonicalization use the same budget, while existing lead context and explicit-year priorities remain. A regression places the complete Church patriarch/Assistant President paragraph beyond the former cutoff and requires its preservation.
