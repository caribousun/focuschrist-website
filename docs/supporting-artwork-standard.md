...
- Apply the same rule to opening copy, foundational-question introductions, notices and surrounding image text. These areas must state concrete subject matter, history, doctrine or visible detail rather than narrating that “this study” connects topics or explaining how the page was assembled.
