...
const cases=[
 ...
 {first:'what year did the pioneer exodus begin',next:'when did it end',expected:[/1846|1847|1869/,/nauvoo|pioneer|migration/i]}
];
for(const page of ['ask','pioneers']) for(const test of cases){
 ...
 assert.equal(r.status,200);assert.equal(p.focuschrist_source_policy,'2026-09-09.67');
