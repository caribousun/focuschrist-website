...
def check_supporting_art_assets(errors: list[str]) -> None:
    floors = {
        ...
        "assets/missionary/christ-teaches-apostles-home-likeness-20260914-900.webp": (900, 507),
        "assets/missionary/christ-teaches-apostles-home-likeness-20260914-1100.webp": (1100, 619),
        "assets/missionary/christ-teaches-apostles-home-likeness-20260914-full.webp": (1672, 941),
    }
    pioneer_sources = {
...
def main() -> int:
    ...
    if "art-ask-context.js?v=20260923-covenant-context-1" not in read("ask.html", errors):
