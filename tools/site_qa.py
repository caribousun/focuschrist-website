...
HEADER_PAGES = {
    **{name: "site-header.css?v=20260906-refined" for name in CORE},
    **{name: "../site-header.css?v=20260906-refined" for name in ANSWER_PAGES},
    **{name: "../site-header.css?v=20260906-refined" for name in ART_STUDY_PAGES},
...
def main() -> int:
    ...
    if '<link rel="stylesheet" href="ask-experience.css?v=20260910-topic-pills-3">' not in ask:
        fail(errors, "Ask experience stylesheet missing")
    if '<script src="ask-experience.js?v=20260910-followup-visibility-5" defer></script>' not in ask:
