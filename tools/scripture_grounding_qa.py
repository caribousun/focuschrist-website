...
required_by_file = {
    "ask.html": (
        ...
        "if(dbResult.verified)", "site-common.js?v=20260901-6", "Legacy fallback path",
    ),
    "site-common.js": (
        ...
        "ungrounded-scripture-attribution", "study-intelligence-v3.js?v=20260901-6",
    ),
    ...
    "groq-proxy/src/index.js": (
        ...
        "SOURCE_POLICY_VERSION = '2026-09-01.6'",
