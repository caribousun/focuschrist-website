...
required_by_file = {
    "ask.html": (
        ...
        "if(dbResult.verified)", "site-common.js?v=20260923-self-help-1", "Legacy fallback path",
    ),
    "site-common.js": (
        ...
        "ungrounded-scripture-attribution", "study-intelligence-v3.js?v=20260923-self-help-1",
    ),
