...
ROOT_PAGES = [
    ...
    "about.html", "watch.html", "404.html", "search.html", "general-conference.html", "joseph-smith-likeness.html",
]
NESTED_PAGES = sorted(
...
def main() -> int:
    ...
    if approved_cache_versions != {"20260924-home-panel-surfaces-1"}:
    ...
    for relative in PUBLIC_PAGES:
        ...
        if 'site-system.css?v=20260924-home-panel-surfaces-1' not in public_text:
    ...
    for marker in ('href="home.css?v=', 'class="fc-home-purpose-split"', 'class="fc-home-purpose-copy"'):
    ...
    supporting_art_links = {
        ...
        "missionary.html": (
            ...
            "assets/missionary/christ-teaches-apostles-home-likeness-20260914-full.webp",
        ),
    }
    ...
    missionary_art_variants = (
        ...
        "assets/missionary/service-missionaries-food-pantry-1400.webp",
        "assets/missionary/christ-teaches-apostles-home-likeness-20260914-900.webp",
        "assets/missionary/christ-teaches-apostles-home-likeness-20260914-1100.webp",
    )
    ...
    if missionary.count('data-missionary-detail=') != 13:
        fail(errors, "missionary.html: expected eleven artwork and two non-scripture study-link detail triggers")
